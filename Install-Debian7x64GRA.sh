...
wget -O /bannerssh "https://dl.dropboxusercontent.com/s/zamygvrz970w3sf/bannerssh.txt"
...
sed -i 's|export KEY_CITY="SanFrancisco"|export KEY_CITY="SamutPrakan"|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="Bang Phli"|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_EMAIL="me@myhost.mydomain"|export KEY_EMAIL="info@byvpn.net"|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_EMAIL=mail@host.domain|export KEY_EMAIL=info@byvpn.net|' /etc/openvpn/easy-rsa/2.0/vars
...
sed -i 's|export KEY_OU=changeme|export KEY_OU=BYVPN|' /etc/openvpn/easy-rsa/2.0/vars
...
dev tun
<connection>
remote $MYIP:1194@kd.truevisions.tv 1194 tcp
</connection>
http-proxy-retry
...
# [√] ยินดีต้อนรับเข้าสู่ Graphicmonland.Net เซิร์ฟเวอร์ มาตรฐาน ราคายุติธรรม
# [√] เกี่ยวกับผู้พัฒนา
# [√] โดย : คุณชายใหญ่ (Graphicmonland)
# [√] เบอร์โทร : 0853994890 - 0917165080
# [√] ไอดีลาย : Graphic11
# [√] เฟชบุ๊ค : https://www.facebook.com/graphicnet.vpn.9
# [√] แฟนเพจ : https://www.facebook.com/graphicnet.vpn.9
# [√] เว็บไซต์ : https://www.graphicmonland.vpn.net
# [√] ลิขสิทธิ์ : © Copyright 2017 graphicmonland.vpn.net all rights reserved.
...
เกี่ยวกับผู้พัฒนา
   ...
   - ไอดีลาย : Graphic11
   - เบอร์โทร : 0853994890 - 0917165080
   - เว็บไซต์ : ยังไม่มีครับ
   - เฟชบุ๊คส่วนตัว : https://www.facebook.com/graphicnet.vpn.9
--------------------------------------------------------
ข้อมูลเซิร์ฟเวอร์
   - IPv6 : (ปิดใช้งาน)
   - Fail2Ban : (เปิดใช้งาน)
